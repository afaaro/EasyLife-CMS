...
<head>
    ...
    <!-- Bootstrap Core CSS -->
    <link href='<?php echo asset("assets/application.css"); ?>' rel="stylesheet">
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><?php echo $config['site_name']; ?></a>
            </div>
            <!-- /.navbar-header -->
        ...
        <?php $controller = Ram::Get("controller"); ?>
        <!-- Page Content -->
        <div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><?php echo $controller; ?></h1>
                    </div>
                    <!-- /.col-lg-12 -->
